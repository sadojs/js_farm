...
INSERT INTO users (email, password_hash, name, role, address)
VALUES ('user@farm.com', '$2b$10$nzFSy4nFDGm2oP5afBzpO.r37PyM7/.7td2RrXdHfep7IzTJU3XLu', '김농부', 'user', '경기도 화성시 농업로 123');
...
SELECT 'user@farm.com / user123 (사용자)' as user_account;
