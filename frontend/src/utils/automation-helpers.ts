...
export function createDefaultIrrigationConditions(): import('../types/automation.types').IrrigationConditions {
  return {
    ...
    zones: [
      ...
      { zone: 5, name: '5구역', duration: 30, waitTime: 5, enabled: true },
      { zone: 6, name: '6구역', duration: 30, waitTime: 5, enabled: true },
      { zone: 7, name: '7구역', duration: 30, waitTime: 5, enabled: true },
      { zone: 8, name: '8구역', duration: 30, waitTime: 5, enabled: true },
    ],
    mixer: { enabled: false },
